...
void commandButtons()
{
  ...
  switch (cmdCombined)
  {
    ...
    case 1282: // cmd group is for uni1 off action
        if( BIT_CHECK(currentStatus.testOutputs, 1) ) { digitalWrite(configPage9.testselectpin[0], LOW); }
      break;
    ...
    case 1285: // cmd group is for uni2 off action
        if( BIT_CHECK(currentStatus.testOutputs, 1) ) { digitalWrite(configPage9.testselectpin[1], LOW); }
      break;
    ...
    case 1288: // cmd group is for uni3 off actions
        if( BIT_CHECK(currentStatus.testOutputs, 1) ) { digitalWrite(configPage9.testselectpin[2], LOW); }
      break;
    ...
    case 1291: // cmd group is for uni4 off actions
        if( BIT_CHECK(currentStatus.testOutputs, 1) ) { digitalWrite(configPage9.testselectpin[3], LOW); }
      break;
    ...
    case 1294: // cmd group is for uni5 off action
        if( BIT_CHECK(currentStatus.testOutputs, 1) ) { digitalWrite(configPage9.testselectpin[4], LOW); }
      break;
    ...
    case 1297: // cmd group is for uni6 off action
        if( BIT_CHECK(currentStatus.testOutputs, 1) ) { digitalWrite(configPage9.testselectpin[5], LOW); }
      break;
    ...
    case 1300: // cmd group is for uni7 off actions
        if( BIT_CHECK(currentStatus.testOutputs, 1) ) { digitalWrite(configPage9.testselectpin[6], LOW); }
      break;
    ...
    case 1303: // cmd group is for uni8 off actions
        if( BIT_CHECK(currentStatus.testOutputs, 1) ) { digitalWrite(configPage9.testselectpin[7], LOW); }
      break;
